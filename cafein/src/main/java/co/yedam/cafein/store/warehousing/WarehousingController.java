...
public class WarehousingController {
	...
	//재고 출고통계 페이지 이동
		@RequestMapping("/warehousinglist.do")
	...
	//입출고 목록 상세내역
		@ResponseBody
		@RequestMapping(value="/getWarehousing", method=RequestMethod.POST)
		public List<WarehousingVO> getWarehousing(Model model, WarehousingVO vo){
						System.out.println(vo.getStartDate());
			System.out.println(vo.getEndDate());
			return warehousingService.getWarehousing(vo);
		}
}
