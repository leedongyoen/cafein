	...
	<div data-panes>
		<div>
			...
			<div data-panes>
				...
				<tr>
					<th><img src="../image/coffee4.jpg" width="200" heigh="200" onclick="location.href='Order.jsp'"></th>
				...
				<tr>
	 			   <td align="center" >에스프레소</td>
	 			   <td align="center">아메리카노</td>
	 			   <td align="center">카페라떼</td>
	 			   <td align="center">카페모카</td>
				</tr>
   		 </table>
				</div>
				<div>
				...
				<tr>
				    <td align="center">홍차라떼</td>
				    <td align="center">녹차라떼</td>
				    <td align="center">레몬에이드</td>
				</tr>
			    </table>
				</div>
			</div>
		...
		<table style="margin-left: auto; margin-right: auto;" width="200" height="200" margin:auto;>
				...
				<tr>
				    <td align="center">프레즐</td>
				    <td align="center">베이글</td>
				    <td align="center">치즈케이크</td>
				</tr>
			    </table>
